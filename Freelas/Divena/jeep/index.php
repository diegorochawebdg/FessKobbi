<?php include('../includes/header.php'); ?>
		...
		<div id="webdoors">
			<div class="webdoor-txt">
				...
				<a href="#" class="info-e-mail">informações <strong>por e-mail</strong></a>
			</div>
		</div>
		<!-- End Webdoors -->
            ...
            <div class="container">
                ...
                <section id="conheca">
                	...
                	<div class="slider">
                		<ul>
	                		<li>
	                			<a href="#">
	                				<figure>
	                					<img src="" alt="Compass" title="Compass">
	                		...
	                		<li>
	                			<a href="#">
	                				<figure>
	                					<img src="" alt="Wrangler" title="Wrangler">
	                		...
	                		<li>
	                			<a href="#">
	                				<figure>
	                					<img src="" alt="Wrangler Unlimited" title="Wrangler Unlimited">
	                		...
	                		<li>
	                			<a href="#">
	                				<figure>
	                					<img src="" alt="Grand Cherokee" title="Grand Cherokee">
	                		...
	                		<li>
	                			<a href="#">
	                				<figure>
	                					<img src="" alt="Cherokee" title="Cherokee">
	                		...
	                		<li>
	                			<a href="#">
	                				<figure>
	                					<img src="" alt="Renegade" title="Renegade">
                	...
                	<main>
                		<!-- Car Image -->
                		<div class="col-md-6">
                			<figure><img src="" alt="Wrangler Unlimited" title="Wrangler Unlimited"></figure>
                		</div>
                		<!-- End Car Image -->

                		<!-- Car Text -->
                		<div class="col-md-6 car-text">
                			<h1>Wrangler Unlimited</h1>
                			...
                			<div class="leads">
                				<ul>
                					<li class="agende"><a href="#" title="Agende um test-drive">Agende um <strong>test-drive</strong></a></li>
									<li class="ligamos"><a href="#" title="Ligamos para você">Ligamos <strong>para você</strong></a></li>
                				</ul>
                			</div>
                		</div>	
                		<!-- End Car Text -->
						...
						<ul>
							<li>
								<a href="#" title="Acessórios">
									<img src="" alt="Acessórios" title="Acessórios">
									<span>Acessórios</span>
								</a>
							</li>
							<li>
								<a href="#" title="Peças">
									<img src="" alt="Peças" title="Peças">
									<span>Peças</span>
								</a>
							</li>
							<li>
								<a href="#" title="Serviços">
									<img src="" alt="Serviços" title="Serviços">
									<span>Serviços</span>
								</a>
							</li>
						</ul>
