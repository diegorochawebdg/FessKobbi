<?php include('../includes/header.php'); ?>
		...
		<style>
			#webdoors li.webdoor1{
				background: url(../assets/images/dodge/webdoor.jpg) no-repeat top;
			}
			...
			.brand-logo{
				background: url(../assets/images/dodge/dodge-logo.png) no-repeat center;
				width: 151px;
				padding-top:35px;
			}
			.button{
				...
				border-top: solid 1px #dc4643;
				border-bottom: solid 1px #8e1a18;
			}
			...
			.slider li a.slide-active:after{
				background: url(../assets/images/active-slide-dodge.png) no-repeat center;
			}
			#outros-servicos form button{
				background: #ba3230;
				background: -moz-linear-gradient(left,  #ba3230 0%, #b43e3d 50%, #ba3230 100%);
				background: -webkit-gradient(linear, left top, right top, color-stop(0%,#ba3230), color-stop(50%,#b43e3d), color-stop(100%,#ba3230));
				background: -webkit-linear-gradient(left,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				background: -o-linear-gradient(left,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				background: -ms-linear-gradient(left,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				background: linear-gradient(to right,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ba3230', endColorstr='#ba3230',GradientType=1 );
				color: #FFF;
			}
			@media screen and (max-width: 767px){
				#webdoors li.webdoor1{
				background: url(../assets/images/dodge/webdoor-mobile.jpg) no-repeat top;
				}
				#webdoors li.webdoor2{
					background: url(../assets/images/dodge/webdoor-mobile.jpg) no-repeat top;
				}
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$(".fotos.compass").click(function() {
				    $.fancybox.open([
				        {
				            href : '../assets/images/dodge/fotos/galeria1.jpg'
				        },
				        {
				            href : '../assets/images/dodge/fotos/galeria2.jpg'
				        }
				    ], {
				        padding : 0
				    });
	                		...
	                		<ul>
		                		...
		                		<li>
		                			<a href="#" data-slide-index="1">
		                				<figure>
		                					<img src="../assets/images/dodge/journey-rt.jpg" height="59" width="134" alt="Journey R/T" title="Journey R/T">
		                					<figcaption>Journey R/T</figcaption>
		                				</figure>
		                			</a>
		                		</li>
		                		<li>
		                			<a href="#" data-slide-index="2">
		                				<figure>
		                					<img src="../assets/images/dodge/journey-rt-awd.jpg" height="59" width="135" alt="Journey R/T AWD" title="Journey R/T AWD">
		                					<figcaption>Journey R/T AWD</figcaption>
		                				</figure>
		                			</a>
		                		</li>
		                		<li>
		                			<a href="#" data-slide-index="3">
		                				<figure>
		                					<img src="../assets/images/dodge/journey-crossroad.jpg" height="59" width="132" alt="Journey Crossroad" title="Journey Crossroad">
		                					<figcaption>Journey Crossroad</figcaption>
		                				</figure>
		                			</a>
		                		</li>
		                	</ul>
