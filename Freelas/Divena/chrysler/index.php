<?php include('../includes/header.php'); ?>
		...
		<style>
			#webdoors li.webdoor1{
				background: url(../assets/images/chrysler/webdoor.jpg) no-repeat top;
			}
			...
			.brand-logo{
				background: url(../assets/images/chrysler/chrysler-logo.png) no-repeat center;
				width: 151px;
				padding-top:35px;
			}
			.button{
				background: #ba3230 url(../assets/images/icons-sprite-white.png) no-repeat;
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -moz-linear-gradient(left,  #ba3230 0%, #b43e3d 50%, #ba3230 100%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -webkit-gradient(linear, left top, right top, color-stop(0%,#ba3230), color-stop(50%,#b43e3d), color-stop(100%,#ba3230));
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -webkit-linear-gradient(left,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -o-linear-gradient(left,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -ms-linear-gradient(left,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, linear-gradient(to right,  #ba3230 0%,#b43e3d 50%,#ba3230 100%);
				filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ba3230', endColorstr='#ba3230',GradientType=1 );


				background: #134673 url(../assets/images/icons-sprite-white.png) no-repeat;
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -moz-linear-gradient(top,  #134673 0%, #275176 50%, #275176 50%, #134673 98%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -webkit-gradient(linear, left top, left bottom, color-stop(0%,#134673), color-stop(50%,#275176), color-stop(50%,#275176), color-stop(98%,#134673));
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -webkit-linear-gradient(top,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -o-linear-gradient(top,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, -ms-linear-gradient(top,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				background: url(../assets/images/icons-sprite-white.png) no-repeat, linear-gradient(to bottom,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#134673', endColorstr='#134673',GradientType=0 );
			...
			.slider li a.slide-active:after{
				background: url(../assets/images/active-slide-chrysler.png) no-repeat center;
			}
			#outros-servicos form button{
				background: #134673;
				background: -moz-linear-gradient(top,  #134673 0%, #275176 50%, #275176 50%, #134673 98%);
				background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#134673), color-stop(50%,#275176), color-stop(50%,#275176), color-stop(98%,#134673));
				background: -webkit-linear-gradient(top,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				background: -o-linear-gradient(top,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				background: -ms-linear-gradient(top,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				background: linear-gradient(to bottom,  #134673 0%,#275176 50%,#275176 50%,#134673 98%);
				filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#134673', endColorstr='#134673',GradientType=0 );
				color: #FFF;
				border: none;
			}
			@media screen and (max-width: 767px){
				#webdoors li.webdoor1{
				background: url(../assets/images/chrysler/webdoor-mobile.jpg) no-repeat top;
				}
				#webdoors li.webdoor2{
					background: url(../assets/images/chrysler/webdoor-mobile.jpg) no-repeat top;
				}
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$(".fotos.300c").click(function() {
				    $.fancybox.open([
				        {
				            href : '../assets/images/chrysler/fotos/galeria1.jpg'
				        },
				        {
				            href : '../assets/images/chrysler/fotos/galeria2.jpg'
				        }
				    ], {
				        padding : 0
				    });
	                		...
	                		<ul>
		                		<li>
		                			<a href="#" data-slide-index="0" class="slide-active">
		                				<figure>
		                					<img src="../assets/images/chrysler/300c.jpg" height="51" width="136" alt="300C" title="300C">
		                					<figcaption>300C</figcaption>
		                				</figure>
		                			</a>
		                		</li>
		                		<li>
		                			<a href="#" data-slide-index="0" class="slide-active">
		                				<figure>
		                					<img src="../assets/images/chrysler/town-country.jpg" height="49" width="135" alt="Town &amp; Country" title="Town &amp; Country">
		                					<figcaption>Town &amp; Country</figcaption>
		                				</figure>
		                			</a>
		                		</li>
		                	</ul>
	                		...
	                		<ul id="car-selector">
	                			<li>
			                		...
			                		<div class="col-md-6 car-text">
			                			...
			                			<div class="link">
			                				...
			                				<a href="../assets/images/ram/fotos/galeria1.jpg" class="fotos 300c">Fotos</a>
			                			</div>
	                			...
	                			<li>
			                		...
			                		<div class="col-md-6 car-text">
			                			...
			                			<div class="link">
			                				<a href="#" class="ficha-tecnica">Ficha técnica</a>
			                				<a href="../assets/images/ram/fotos/galeria1.jpg" class="fotos country">Fotos</a>
			                			</div>
