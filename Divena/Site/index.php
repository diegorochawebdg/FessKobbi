		...
		<div class="content-center">
			...
			<div id="section-menu">
				<ul>
					 ...
					 <li class="todos-veiculos animate">
					 	<span>Todos os veículos</span>
					 	<ul class="animate">
					 		<!-- <li class="carros-slide-menu"><a href="#" title="Carros">Carros</a></li> -->
					 		<li class="vans-slide-menu"><a href="#" title="Vans">Vans</a></li>
					 		<li class="caminhoes-slide-menu" ><a href="#"title="Caminhões">Caminhões</a></li>
					 		<li class="onibus-slide-menu"><a href="#" title="Ônibus">Ônibus</a></li>
					 	</ul>
					 	<div class="category-img animate sem-carro"></div>
					 </li>
				</ul>
				<div class="clear"></div>
			</div>
