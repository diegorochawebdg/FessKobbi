...
<div id="sidebar">
    <div class="header-sidebar">
        <div class="txt">
            <h3>A Wall Street English <strong>vai até você</strong></h3>
            <a href="#" title="Para sua empresa">Para sua empresa</a>
            <a href="http://www.wsenglish.com.br/" title="WSE para você" class="para-voce">WSE para você</a>
            <img src="images/sidebar/wall-street-logo.png" alt="Logotipo Wall Street English" title="Wall Street English">
        </div>
    </div>
    <div class="content-sidebar">
        <p>A Wall Street English é a sua melhor opção para o ensino de inglês no mundo empresarial. Agende a visita de um gerente corporativo à sua empresa e saiba mais.</p>
        <p>Seja um parceiro da Wall Street English e tenha uma equipe melhor preparada para qualquer situação.</p>
        <form name="agende">
        ...
        <a href="http://www.wallstreetenglish.com.br/" target="_blank" title="Saiba mais sobre a Wall Street English">Saber mais sobre a WSE?</a>
    </div>
</div>