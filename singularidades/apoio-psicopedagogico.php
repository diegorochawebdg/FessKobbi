...
<div class="content-center">
    ...
    <!--Title-->
    <div class="title">
        <h1>Graduação / <strong>Apoio psicopedagógico</strong></h1>
    </div>
    <!--End of Title-->
    ...
    <div class="left">
        ...
        <ul class="main-menu">
            ...
            <li class="active"><a href="#" title="Apoio psicopedagógico">Apoio psicopedagógico</a></li>
    ...
    <div class="right">
        ...
        <h2>Enim te te culpa doctrina ex do nescius ita proident aut quamquam amet quorum</h2>
