...
<div class="content-center">
    ...
    <div class="path">
        ...
        <span>></span>
        <a href="#" title="contato">o singularidades</a>
        <span>></span>
    ...
    <!--Title-->
    <div class="title">
        <h1>O Singularidades / <strong>Trabalhe Conosco</strong></h1>
    </div>
    <!--End of Title-->
    ...
    <div class="right">
        ...
        <div class="form">
            <form>
                ...
                <button class="anexar right-input animate">Anexar arquivo</button>
                <div class="clear"></div>
